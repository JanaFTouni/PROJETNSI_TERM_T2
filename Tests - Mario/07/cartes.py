...
def carte1_1_blocs() -> list[classes.Bloc]:
    ...
    carte += [classes.Bloc(1248 + (16*i), 144, 32, 16) for i in range(3)]
    ...
    carte += [classes.Bloc(1744, 80, 48, 16)]
...
def carte1_1_entites() -> list[classes.Entite]:
    ...
    carte += [classes.Entite(2084, 192, 1, "goomba")]
    carte += [classes.Entite(2060, 192, -1, "goomba")]
    carte += [classes.Entite(2040, 192, -1, "goomba")]
    carte += [classes.Entite(2025, 192, -1, "goomba")]
    carte += [classes.Entite(1690, 192, -1, "goomba")]
